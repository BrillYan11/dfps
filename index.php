            ...
            <?php if (isset($_SESSION['user_id'])): ?>
                <?php
                    ...
                    if (isset($_SESSION['role'])) {
                        if ($_SESSION['role'] == 'FARMER') $dashboard_link = 'farmer/index.php';
                        elseif ($_SESSION['role'] == 'BUYER') $dashboard_link = 'buyer/index.php';
                        elseif ($_SESSION['role'] == 'DA') $dashboard_link = 'da/index.php';
                    }
                ?>
                <a href="<?php echo $dashboard_link; ?>" class="btn btn-hero-primary text-white">Go to Dashboard</a>
                <a href="logout.php" class="btn btn-hero-outline">Logout</a>
            <?php else: ?>
                <a href="login.php" class="btn btn-hero-primary text-white">Login Now</a>
                <a href="register.php" class="btn btn-hero-outline">Join as Member</a>
            <?php endif; ?>
        </div>
    </div>
</div>
