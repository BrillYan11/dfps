    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="d-flex align-items-center mb-4">
                <a href="<?php echo dfps_url('farmer/'); ?>" class="btn btn-light rounded-circle me-3 shadow-sm">
                    <i class="bi bi-arrow-left"></i>
                </a>
                <h2 class="mb-0 fw-bold">All Announcements</h2>
            </div>
            ...
            <?php if (empty($announcements)): ?>
                <div class="card border-0 shadow-sm rounded-4 p-5 text-center">
                    ...
                    <p class="text-muted">Check back later for updates from the Department of Agriculture.</p>
                </div>
            <?php else: ?>
                <div class="row g-3">
