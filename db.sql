...
-- Aligned with the latest application requirements (May 2026)
-- =========================================================
...
-- =========================================================
-- USERS
-- roles: FARMER, BUYER, DA, DA_SUPER_ADMIN
-- =========================================================
CREATE TABLE users (
  id INT AUTO_INCREMENT PRIMARY KEY,
  ...
  role ENUM('FARMER','BUYER','DA','DA_SUPER_ADMIN') NOT NULL,
  area_id INT NULL,
...
-- status: ACTIVE, SOLD, HIDDEN, FLAGGED, ARCHIVED
-- =========================================================
CREATE TABLE posts (
  id INT AUTO_INCREMENT PRIMARY KEY,
  ...
  unit VARCHAR(30) NOT NULL DEFAULT 'kg',
  area_id INT NULL,
  status ENUM('ACTIVE','SOLD','HIDDEN','FLAGGED','ARCHIVED') NOT NULL DEFAULT 'ACTIVE',
  is_deleted TINYINT(1) NOT NULL DEFAULT 0,
  created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- Seed data
-- =========================================================
INSERT INTO areas (name) VALUES ('Manila'), ('Quezon City'), ('Davao City'), ('Cebu City');

INSERT INTO produce (name, unit, srp) VALUES
  ('Tomato','kg', 80.00),
  ('Onion','kg', 120.00),
  ('Rice','kg', 50.00),
  ('Potato','kg', 90.00),
...
INSERT INTO users (first_name, last_name, username, address, email, phone, password_hash, role, is_active)
VALUES ('System', 'Admin', 'admin', 'DA Office', 'admin@dfps.gov.ph', '09170000000', '$2y$10$WkGv7B7vIuI8oBf0mRzH.u3j8g5p2b1Y9k1Z8u1p1Y1k1Z8u1p1Y1', 'DA_SUPER_ADMIN', 1);
-- Note: The above hash is a placeholder. Real systems should use a secure hash.
